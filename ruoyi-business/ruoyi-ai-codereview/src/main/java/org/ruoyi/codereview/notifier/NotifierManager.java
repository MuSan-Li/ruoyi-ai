...
public class NotifierManager {
    ...
    public NotifierManager(List<Notifier> notifierList) {
     ...
     * 发送 MR 审查完成通知
     */
    public void notifyMergeRequestReviewed(String projectName, String author,
     ...
     * 发送 Push 审查完成通知
     */
    public void notifyPushReviewed(String projectName, String author, String branch, int score, String reviewResult) {
        String title = "代码审查完成 - " + projectName;
